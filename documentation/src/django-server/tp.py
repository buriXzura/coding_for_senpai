#!/usr/bin/env python3
"""! @brief CS 251 Course Project: Red Plag Plaigarism Checker by CodingForSenpai."""
##
# @mainpage Red Plag Plaigarism Checker
#
...
# - Shabnam Sahay
#
# Copyright (c) CodingForSenpai.  All rights reserved.
# Imports
